...
namespace watermossmc\tools\compact_regions;

use watermossmc\utils\Utils;
use watermossmc\world\format\io\exception\CorruptedChunkException;
use watermossmc\world\format\io\region\CorruptedRegionException;
use watermossmc\world\format\io\region\RegionLoader;
...
if (!defined('watermossmc\_PHPSTAN_ANALYSIS')) {
	exit(main($argv));
}
