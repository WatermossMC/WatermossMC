...
use watermossmc\event\fixtures\TestAbstractAllowHandleEvent;
use watermossmc\event\fixtures\TestAbstractEvent;
use watermossmc\event\fixtures\TestConcreteEvent;
use watermossmc\event\fixtures\TestConcreteExtendsAbstractEvent;
use watermossmc\event\fixtures\TestConcreteExtendsAllowHandleEvent;
use watermossmc\event\fixtures\TestConcreteExtendsConcreteEvent;
