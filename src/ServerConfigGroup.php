...
final class ServerConfigGroup
{
	...
	public function getProperty(string $variable, mixed $defaultValue = null) : mixed
	{
		if (!array_key_exists($variable, $this->propertyCache)) {
			...
			if (isset($v[$variable])) {
				...
				$this->propertyCache[$variable] = $this->watermossmcYml->getNested($variable);
			}
		}
	...
	public function save() : void
	{
		...
		if ($this->watermossmcYml->hasChanged()) {
			$this->watermossmcYml->save();
		}
	}
}
