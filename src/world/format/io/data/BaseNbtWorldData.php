...
namespace watermossmc\world\format\io\data;
...
abstract class BaseNbtWorldData implements WorldData
{
	...
	/**
	 * Hack to fix worlds broken previously by older versions of WatermossMC which incorrectly saved classpaths of
	...
	protected static function hackyFixForGeneratorClasspathInLevelDat(string $className) : ?string
	{
		...
		switch ($className) {
			...
			case 'watermossmc\level\generator\normal\Normal':
				return "normal";
				/** @noinspection ClassConstantCanBeUsedInspection */
			case 'watermossmc\level\generator\Flat':
				return "flat";
		}
