...
final class World
{
    ...
    private array $spawn = ['x' => 0, 'y' => 65, 'z' => 0];
    ...
    {
        return ['x' => $this->spawn['x'] + 0.5, 'y' => (float) $this->spawn['y'], 'z' => $this->spawn['z'] + 0.5];
    }
    ...
    {
        $payload = NBT::compound(['Data' => ['LevelName' => $this->name, 'RandomSeed' => $this->seed, 'GameType' => $this->gameType, 'Time' => $this->time, 'DayTime' => $this->dayTime, 'LastPlayed' => time(), 'SpawnX' => $this->spawn['x'], 'SpawnY' => $this->spawn['y'], 'SpawnZ' => $this->spawn['z'], 'generatorName' => 'watermoss_overworld', 'generatorVersion' => 2, 'version' => ['Name' => 'WatermossMC', 'Id' => 2480]]]);
    ...
    {
        return abs($x - $this->spawn['x']) <= self::SPAWN_PLATFORM_RADIUS && abs($z - $this->spawn['z']) <= self::SPAWN_PLATFORM_RADIUS;
    }
