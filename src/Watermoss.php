...
namespace watermossmc {
	...
	use watermossmc\thread\ThreadManager;
	...
	use watermossmc\utils\ServerKiller;
	use watermossmc\utils\Terminal;
	use watermossmc\utils\Timezone;
	use watermossmc\utils\Utils;
	use watermossmc\wizard\SetupWizard;
	...
	function check_platform_dependencies(){
		...
		if(extension_loaded("watermossmc")){
...
JIT_WARNING
	...
	function server(){
		...
		if(defined('watermossmc\ORIGINAL_PHAR_PATH')){
			//if we're inside a phar cache, \watermossmc\PATH will not include the original phar
