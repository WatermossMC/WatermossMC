...
use watermossmc\event\entity\EntityDespawnEvent;
use watermossmc\event\entity\EntityMotionEvent;
use watermossmc\event\entity\EntityRegainHealthEvent;
use watermossmc\event\entity\EntitySpawnEvent;
use watermossmc\event\entity\EntityTeleportEvent;
	...
	protected function broadcastMovement(bool $teleport = false) : void
	{
		NetworkBroadcastUtils::broadcastPackets($this->hasSpawned, [MoveActorAbsolutePacket::create(
			...
			(
				...
				//See https://github.com/pmmp/WatermossMC/issues/4394
