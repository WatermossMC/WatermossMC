...
use watermossmc\event\entity\EntityCombustByEntityEvent;
...
use watermossmc\event\entity\ProjectileHitBlockEvent;
use watermossmc\event\entity\ProjectileHitEntityEvent;
