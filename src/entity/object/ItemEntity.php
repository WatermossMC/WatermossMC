...
use watermossmc\entity\animation\ItemEntityStackSizeChangeAnimation;
use watermossmc\entity\Entity;
use watermossmc\entity\EntitySizeInfo;
use watermossmc\entity\Location;
use watermossmc\event\entity\EntityItemPickupEvent;
use watermossmc\event\entity\ItemDespawnEvent;
use watermossmc\event\entity\ItemMergeEvent;
use watermossmc\event\entity\ItemSpawnEvent;
