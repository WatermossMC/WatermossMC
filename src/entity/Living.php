...
use watermossmc\entity\animation\DeathAnimation;
use watermossmc\entity\animation\HurtAnimation;
use watermossmc\entity\animation\RespawnAnimation;
use watermossmc\entity\effect\EffectInstance;
use watermossmc\entity\effect\EffectManager;
...
use watermossmc\event\entity\EntityDeathEvent;
...
use watermossmc\math\VoxelRayTrace;
use watermossmc\nbt\tag\CompoundTag;
use watermossmc\nbt\tag\FloatTag;
use watermossmc\nbt\tag\ListTag;
use watermossmc\nbt\tag\ShortTag;
...
use watermossmc\world\sound\BurpSound;
use watermossmc\world\sound\EntityLandSound;
use watermossmc\world\sound\EntityLongFallSound;
use watermossmc\world\sound\EntityShortFallSound;
...
abstract class Living extends Entity
{
	...
	protected function initEntity(CompoundTag $nbt) : void
	{
		...
		if (($healFTag = $nbt->getTag(self::TAG_LEGACY_HEALTH)) instanceof FloatTag) {
			...
			$health = $healthTag->getValue(); //Older versions of WatermossMC incorrectly saved this as a short instead of a float
