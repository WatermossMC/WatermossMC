...
use watermossmc\entity\animation\TotemUseAnimation;
use watermossmc\entity\effect\EffectInstance;
use watermossmc\entity\effect\VanillaEffects;
use watermossmc\entity\projectile\ProjectileSource;
...
use watermossmc\world\sound\TotemUseSound;
