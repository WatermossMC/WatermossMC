...
use watermossmc\entity\utils\ExperienceUtils;
use watermossmc\event\player\PlayerExperienceChangeEvent;
use watermossmc\item\Durable;
use watermossmc\item\enchantment\VanillaEnchantments;
use watermossmc\utils\Limits;
use watermossmc\world\sound\XpCollectSound;
use watermossmc\world\sound\XpLevelUpSound;
