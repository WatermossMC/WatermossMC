...
use watermossmc\data\bedrock\CompoundTypeIds;
use watermossmc\data\bedrock\DyeColorIdMap;
use watermossmc\data\bedrock\GoatHornTypeIdMap;
use watermossmc\data\bedrock\item\ItemTypeNames as Ids;
use watermossmc\data\bedrock\item\SavedItemData as Data;
use watermossmc\data\bedrock\MedicineTypeIdMap;
use watermossmc\data\bedrock\PotionTypeIdMap;
use watermossmc\data\bedrock\SuspiciousStewTypeIdMap;
use watermossmc\item\Banner;
use watermossmc\item\Dye;
use watermossmc\item\GoatHorn;
use watermossmc\item\Item;
use watermossmc\item\Medicine;
use watermossmc\item\Potion;
use watermossmc\item\SplashPotion;
use watermossmc\item\SuspiciousStew;
use watermossmc\item\VanillaItems as Items;
...
final class ItemSerializerDeserializerRegistrar
{
	...
	/**
	 * Registers mappings for item IDs which directly correspond to WatermossMC blockitems.
	...
	/**
	 * Registers mappings for item IDs which directly correspond to WatermossMC items.
	 */
	...
	/**
	 * Registers mappings for item IDs which map to different WatermossMC item types, depending on their meta
	 * values.
	 ...
	 *
	 * Most of these are single WatermossMC items which map to multiple IDs depending on their properties, which is
	...
	/**
	 * Registers serializers and deserializers for WatermossMC blockitems that don't fit any other pattern.
	 * Ideally we want to get rid of this completely, if possible.
	 *
	 * Most of these are single WatermossMC blocks which map to multiple IDs depending on their properties, which is
	 * complex to implement in a generic way.
	 */
