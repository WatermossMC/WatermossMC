...
use watermossmc\data\bedrock\block\upgrade\model\BlockStateUpgradeSchemaModel;
use watermossmc\data\bedrock\block\upgrade\model\BlockStateUpgradeSchemaModelBlockRemap;
use watermossmc\data\bedrock\block\upgrade\model\BlockStateUpgradeSchemaModelFlattenInfo;
use watermossmc\data\bedrock\block\upgrade\model\BlockStateUpgradeSchemaModelTag;
use watermossmc\data\bedrock\block\upgrade\model\BlockStateUpgradeSchemaModelValueRemap;
use watermossmc\nbt\tag\ByteTag;
use watermossmc\nbt\tag\IntTag;
use watermossmc\nbt\tag\StringTag;
use watermossmc\nbt\tag\Tag;
