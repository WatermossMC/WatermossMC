...
use watermossmc\block\ActivatorRail;
use watermossmc\block\AmethystCluster;
use watermossmc\block\Anvil;
use watermossmc\block\Bamboo;
use watermossmc\block\BambooSapling;
use watermossmc\block\Barrel;
use watermossmc\block\Bed;
use watermossmc\block\Beetroot;
use watermossmc\block\Bell;
use watermossmc\block\BigDripleafHead;
use watermossmc\block\BigDripleafStem;
use watermossmc\block\Block;
use watermossmc\block\BoneBlock;
use watermossmc\block\BrewingStand;
use watermossmc\block\BrownMushroomBlock;
use watermossmc\block\Button;
use watermossmc\block\Cactus;
use watermossmc\block\Cake;
use watermossmc\block\CakeWithCandle;
use watermossmc\block\CakeWithDyedCandle;
use watermossmc\block\Campfire;
use watermossmc\block\Candle;
use watermossmc\block\Carpet;
use watermossmc\block\Carrot;
use watermossmc\block\CarvedPumpkin;
use watermossmc\block\CaveVines;
use watermossmc\block\Chain;
use watermossmc\block\ChemistryTable;
use watermossmc\block\Chest;
use watermossmc\block\ChiseledBookshelf;
use watermossmc\block\ChorusFlower;
use watermossmc\block\CocoaBlock;
use watermossmc\block\Concrete;
use watermossmc\block\ConcretePowder;
use watermossmc\block\Copper;
use watermossmc\block\CopperBulb;
use watermossmc\block\CopperDoor;
use watermossmc\block\CopperGrate;
use watermossmc\block\CopperSlab;
use watermossmc\block\CopperStairs;
use watermossmc\block\CopperTrapdoor;
use watermossmc\block\Coral;
use watermossmc\block\CoralBlock;
use watermossmc\block\DaylightSensor;
use watermossmc\block\DetectorRail;
use watermossmc\block\Dirt;
use watermossmc\block\Door;
use watermossmc\block\DoublePitcherCrop;
use watermossmc\block\DoublePlant;
use watermossmc\block\DoubleTallGrass;
use watermossmc\block\DyedCandle;
use watermossmc\block\DyedShulkerBox;
use watermossmc\block\EnderChest;
use watermossmc\block\EndPortalFrame;
use watermossmc\block\EndRod;
use watermossmc\block\Farmland;
use watermossmc\block\FenceGate;
use watermossmc\block\FillableCauldron;
use watermossmc\block\Fire;
use watermossmc\block\FloorBanner;
use watermossmc\block\FloorCoralFan;
use watermossmc\block\FloorSign;
use watermossmc\block\Froglight;
use watermossmc\block\FrostedIce;
use watermossmc\block\Furnace;
use watermossmc\block\GlazedTerracotta;
use watermossmc\block\GlowLichen;
use watermossmc\block\HayBale;
use watermossmc\block\Hopper;
use watermossmc\block\ItemFrame;
use watermossmc\block\Ladder;
use watermossmc\block\Lantern;
use watermossmc\block\Lava;
use watermossmc\block\Leaves;
use watermossmc\block\Lectern;
use watermossmc\block\Lever;
use watermossmc\block\Light;
use watermossmc\block\LightningRod;
use watermossmc\block\LitPumpkin;
use watermossmc\block\Loom;
use watermossmc\block\MelonStem;
use watermossmc\block\MobHead;
use watermossmc\block\NetherPortal;
use watermossmc\block\NetherVines;
use watermossmc\block\NetherWartPlant;
use watermossmc\block\PinkPetals;
use watermossmc\block\PitcherCrop;
use watermossmc\block\Potato;
use watermossmc\block\PoweredRail;
use watermossmc\block\PumpkinStem;
use watermossmc\block\Rail;
use watermossmc\block\RedMushroomBlock;
use watermossmc\block\RedstoneComparator;
use watermossmc\block\RedstoneLamp;
use watermossmc\block\RedstoneOre;
use watermossmc\block\RedstoneRepeater;
use watermossmc\block\RedstoneTorch;
use watermossmc\block\RedstoneWire;
use watermossmc\block\RuntimeBlockStateRegistry;
use watermossmc\block\Sapling;
use watermossmc\block\SeaPickle;
use watermossmc\block\SimplePillar;
use watermossmc\block\SimplePressurePlate;
use watermossmc\block\Slab;
use watermossmc\block\SmallDripleaf;
use watermossmc\block\SnowLayer;
use watermossmc\block\SoulCampfire;
use watermossmc\block\Sponge;
use watermossmc\block\StainedGlass;
use watermossmc\block\StainedGlassPane;
use watermossmc\block\StainedHardenedClay;
use watermossmc\block\StainedHardenedGlass;
use watermossmc\block\StainedHardenedGlassPane;
use watermossmc\block\Stair;
use watermossmc\block\StoneButton;
use watermossmc\block\Stonecutter;
use watermossmc\block\StonePressurePlate;
use watermossmc\block\Sugarcane;
use watermossmc\block\SweetBerryBush;
use watermossmc\block\TNT;
use watermossmc\block\Torch;
use watermossmc\block\TorchflowerCrop;
use watermossmc\block\Trapdoor;
use watermossmc\block\TrappedChest;
use watermossmc\block\Tripwire;
use watermossmc\block\TripwireHook;
use watermossmc\block\UnderwaterTorch;
use watermossmc\block\utils\BrewingStandSlot;
use watermossmc\block\utils\CoralType;
...
use watermossmc\block\VanillaBlocks as Blocks;
use watermossmc\block\Vine;
use watermossmc\block\Wall;
use watermossmc\block\WallBanner;
use watermossmc\block\WallCoralFan;
use watermossmc\block\WallSign;
use watermossmc\block\Water;
use watermossmc\block\WeightedPressurePlateHeavy;
use watermossmc\block\WeightedPressurePlateLight;
use watermossmc\block\Wheat;
use watermossmc\block\Wood;
use watermossmc\block\WoodenButton;
use watermossmc\block\WoodenDoor;
use watermossmc\block\WoodenPressurePlate;
use watermossmc\block\WoodenStairs;
use watermossmc\block\WoodenTrapdoor;
use watermossmc\block\Wool;
...
use watermossmc\data\bedrock\block\BlockStateStringValues as StringValues;
use watermossmc\data\bedrock\block\BlockTypeNames as Ids;
use watermossmc\data\bedrock\block\convert\BlockStateSerializerHelper as Helper;
use watermossmc\data\bedrock\block\convert\BlockStateWriter as Writer;
...
final class BlockObjectToStateSerializer implements BlockStateSerializer
{
	...
	private function registerFlatCoralSerializers() : void
	{
		...
		$this->map(
			Blocks::WALL_CORAL_FAN(),
			fn (WallCoralFan $block) => Writer::create(
				match($block->getCoralType()) {
	...
	private function registerSerializers() : void
	{
		...
		$this->map(
			...
			fn (AmethystCluster $block) => Writer::create(
		...
		$this->map(
			Blocks::ANVIL(),
			fn (Anvil $block) : Writer => Writer::create(
		...
		$this->map(
			Blocks::TNT(),
			fn (TNT $block) => Writer::create($block->worksUnderwater() ? Ids::UNDERWATER_TNT : Ids::TNT)
