...
use watermossmc\crafting\ExactRecipeIngredient;
use watermossmc\crafting\MetaWildcardRecipeIngredient;
use watermossmc\crafting\RecipeIngredient;
use watermossmc\crafting\TagWildcardRecipeIngredient;
...
class TypeConverter
{
	...
	public function getBlockTranslator() : BlockTranslator
	{
	...
	public function getItemTranslator() : ItemTranslator
	{
