...
use watermossmc\data\bedrock\item\ItemTypeSerializeException;
...
/**
 * This class handles translation between network item ID+metadata to WatermossMC internal ID+metadata and vice versa.
 */
