...
use watermossmc\block\inventory\BlockInventory;
use watermossmc\block\inventory\BrewingStandInventory;
use watermossmc\block\inventory\CartographyTableInventory;
use watermossmc\block\inventory\CraftingTableInventory;
use watermossmc\block\inventory\EnchantInventory;
use watermossmc\block\inventory\FurnaceInventory;
use watermossmc\block\inventory\HopperInventory;
use watermossmc\block\inventory\LoomInventory;
use watermossmc\block\inventory\SmithingTableInventory;
use watermossmc\block\inventory\StonecutterInventory;
use watermossmc\crafting\FurnaceType;
use watermossmc\data\bedrock\EnchantmentIdMap;
