...
/**
 * This class contains factory methods for all the translations known to WatermossMC as per the used version of
 * pmmp/Language.
...
final class KnownTranslationFactory
{
	...
	public static function watermossmc_command_alias_illegal(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_command_alias_notFound(Translatable|string $param0, Translatable|string $param1) : Translatable
	{
	...
	public static function watermossmc_command_alias_recursive(Translatable|string $param0, Translatable|string $param1) : Translatable
	{
	...
	public static function watermossmc_command_ban_ip_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_BAN_IP_DESCRIPTION, []);
	}

	public static function watermossmc_command_ban_player_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_BAN_PLAYER_DESCRIPTION, []);
	}

	public static function watermossmc_command_banlist_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_BANLIST_DESCRIPTION, []);
	}

	public static function watermossmc_command_clear_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_CLEAR_DESCRIPTION, []);
	}

	public static function watermossmc_command_clear_usage() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_CLEAR_USAGE, []);
	}

	public static function watermossmc_command_defaultgamemode_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_DEFAULTGAMEMODE_DESCRIPTION, []);
	}

	public static function watermossmc_command_deop_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_DEOP_DESCRIPTION, []);
	}

	public static function watermossmc_command_difficulty_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_DIFFICULTY_DESCRIPTION, []);
	}

	public static function watermossmc_command_dumpmemory_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_DUMPMEMORY_DESCRIPTION, []);
	}

	public static function watermossmc_command_effect_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_EFFECT_DESCRIPTION, []);
	}

	public static function watermossmc_command_enchant_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_ENCHANT_DESCRIPTION, []);
	}

	public static function watermossmc_command_error_permission(Translatable|string $commandName) : Translatable
	{
	...
	public static function watermossmc_command_error_playerNotFound(Translatable|string $playerName) : Translatable
	{
	...
	public static function watermossmc_command_exception(Translatable|string $param0, Translatable|string $param1, Translatable|string $param2) : Translatable
	{
	...
	public static function watermossmc_command_gamemode_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_GAMEMODE_DESCRIPTION, []);
	}

	public static function watermossmc_command_gamemode_failure(Translatable|string $playerName) : Translatable
	{
	...
	public static function watermossmc_command_gamemode_unknown(Translatable|string $gameModeName) : Translatable
	{
	...
	public static function watermossmc_command_gc_chunks(Translatable|string $chunksCollected) : Translatable
	{
	...
	public static function watermossmc_command_gc_cycles(Translatable|string $cyclesCollected) : Translatable
	{
	...
	public static function watermossmc_command_gc_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_GC_DESCRIPTION, []);
	}

	public static function watermossmc_command_gc_entities(Translatable|string $entitiesCollected) : Translatable
	{
	...
	public static function watermossmc_command_gc_header() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_GC_HEADER, []);
	}

	public static function watermossmc_command_gc_memoryFreed(Translatable|string $memoryFreed) : Translatable
	{
	...
	public static function watermossmc_command_give_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_GIVE_DESCRIPTION, []);
	}

	public static function watermossmc_command_give_usage() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_GIVE_USAGE, []);
	}

	public static function watermossmc_command_help_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_HELP_DESCRIPTION, []);
	}

	public static function watermossmc_command_help_specificCommand_aliases(Translatable|string $aliasList) : Translatable
	{
	...
	public static function watermossmc_command_help_specificCommand_description(Translatable|string $description) : Translatable
	{
	...
	public static function watermossmc_command_help_specificCommand_header(Translatable|string $commandName) : Translatable
	{
	...
	public static function watermossmc_command_help_specificCommand_usage(Translatable|string $usage) : Translatable
	{
	...
	public static function watermossmc_command_kick_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_KICK_DESCRIPTION, []);
	}

	public static function watermossmc_command_kill_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_KILL_DESCRIPTION, []);
	}

	public static function watermossmc_command_kill_usage() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_KILL_USAGE, []);
	}

	public static function watermossmc_command_list_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_LIST_DESCRIPTION, []);
	}

	public static function watermossmc_command_me_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_ME_DESCRIPTION, []);
	}

	public static function watermossmc_command_notFound(Translatable|string $commandName, Translatable|string $helpCommand) : Translatable
	{
	...
	public static function watermossmc_command_op_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_OP_DESCRIPTION, []);
	}

	public static function watermossmc_command_particle_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_PARTICLE_DESCRIPTION, []);
	}

	public static function watermossmc_command_particle_usage() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_PARTICLE_USAGE, []);
	}

	public static function watermossmc_command_plugins_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_PLUGINS_DESCRIPTION, []);
	}

	public static function watermossmc_command_plugins_success(Translatable|string $param0, Translatable|string $param1) : Translatable
	{
	...
	public static function watermossmc_command_timings_timingsUpload(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_command_timings_timingsWrite(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_command_timings_usage() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_TIMINGS_USAGE, []);
	}

	public static function watermossmc_command_title_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_TITLE_DESCRIPTION, []);
	}

	public static function watermossmc_command_tp_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_TP_DESCRIPTION, []);
	}

	public static function watermossmc_command_transferserver_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_TRANSFERSERVER_DESCRIPTION, []);
	}

	public static function watermossmc_command_transferserver_usage() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_TRANSFERSERVER_USAGE, []);
	}

	public static function watermossmc_command_unban_ip_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_UNBAN_IP_DESCRIPTION, []);
	}

	public static function watermossmc_command_unban_player_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_UNBAN_PLAYER_DESCRIPTION, []);
	}

	public static function watermossmc_command_userDefined_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_USERDEFINED_DESCRIPTION, []);
	}

	public static function watermossmc_command_version_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_VERSION_DESCRIPTION, []);
	}

	public static function watermossmc_command_version_minecraftVersion(Translatable|string $minecraftVersion, Translatable|string $minecraftProtocolVersion) : Translatable
	{
	...
	public static function watermossmc_command_version_noSuchPlugin() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_VERSION_NOSUCHPLUGIN, []);
	}

	public static function watermossmc_command_version_operatingSystem(Translatable|string $operatingSystemName) : Translatable
	{
	...
	public static function watermossmc_command_version_phpJitDisabled() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_VERSION_PHPJITDISABLED, []);
	}

	public static function watermossmc_command_version_phpJitEnabled(Translatable|string $extraJitInfo) : Translatable
	{
	...
	public static function watermossmc_command_version_phpJitNotSupported() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_VERSION_PHPJITNOTSUPPORTED, []);
	}

	public static function watermossmc_command_version_phpJitStatus(Translatable|string $jitStatus) : Translatable
	{
	...
	public static function watermossmc_command_version_phpVersion(Translatable|string $phpVersion) : Translatable
	{
	...
	public static function watermossmc_command_version_serverSoftwareName(Translatable|string $serverSoftwareName) : Translatable
	{
	...
	public static function watermossmc_command_version_serverSoftwareVersion(Translatable|string $serverSoftwareVersion, Translatable|string $serverGitHash) : Translatable
	{
	...
	public static function watermossmc_command_version_usage() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_VERSION_USAGE, []);
	}

	public static function watermossmc_command_whitelist_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_WHITELIST_DESCRIPTION, []);
	}

	public static function watermossmc_command_xp_description() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_XP_DESCRIPTION, []);
	}

	public static function watermossmc_command_xp_usage() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_COMMAND_XP_USAGE, []);
	}

	public static function watermossmc_crash_archive(Translatable|string $param0, Translatable|string $param1) : Translatable
	{
	...
	public static function watermossmc_crash_create() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_CRASH_CREATE, []);
	}

	public static function watermossmc_crash_error(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_crash_submit(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_data_playerCorrupted(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_data_playerNotFound(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_data_playerOld(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_data_saveError(Translatable|string $param0, Translatable|string $param1) : Translatable
	{
	...
	public static function watermossmc_debug_enable() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DEBUG_ENABLE, []);
	}

	public static function watermossmc_disconnect_ban(Translatable|string $reason) : Translatable
	{
	...
	public static function watermossmc_disconnect_ban_hardcore() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_BAN_HARDCORE, []);
	}

	public static function watermossmc_disconnect_ban_ip() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_BAN_IP, []);
	}

	public static function watermossmc_disconnect_ban_noReason() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_BAN_NOREASON, []);
	}

	public static function watermossmc_disconnect_clientDisconnect() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_CLIENTDISCONNECT, []);
	}

	public static function watermossmc_disconnect_clientReconnect() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_CLIENTRECONNECT, []);
	}

	public static function watermossmc_disconnect_error(Translatable|string $error, Translatable|string $errorId) : Translatable
	{
	...
	public static function watermossmc_disconnect_error_authentication() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_ERROR_AUTHENTICATION, []);
	}

	public static function watermossmc_disconnect_error_badPacket() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_ERROR_BADPACKET, []);
	}

	public static function watermossmc_disconnect_error_internal() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_ERROR_INTERNAL, []);
	}

	public static function watermossmc_disconnect_error_loginTimeout() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_ERROR_LOGINTIMEOUT, []);
	}

	public static function watermossmc_disconnect_error_respawn() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_ERROR_RESPAWN, []);
	}

	public static function watermossmc_disconnect_error_timeout() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_ERROR_TIMEOUT, []);
	}

	public static function watermossmc_disconnect_incompatibleProtocol(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_disconnect_invalidSession(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_disconnect_invalidSession_badSignature() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_INVALIDSESSION_BADSIGNATURE, []);
	}

	public static function watermossmc_disconnect_invalidSession_missingKey() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_INVALIDSESSION_MISSINGKEY, []);
	}

	public static function watermossmc_disconnect_invalidSession_tooEarly() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_INVALIDSESSION_TOOEARLY, []);
	}

	public static function watermossmc_disconnect_invalidSession_tooLate() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_INVALIDSESSION_TOOLATE, []);
	}

	public static function watermossmc_disconnect_kick(Translatable|string $reason) : Translatable
	{
	...
	public static function watermossmc_disconnect_kick_noReason() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_KICK_NOREASON, []);
	}

	public static function watermossmc_disconnect_transfer() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_TRANSFER, []);
	}

	public static function watermossmc_disconnect_whitelisted() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_WHITELISTED, []);
	}

	public static function watermossmc_disconnect_xblImpersonation() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_DISCONNECT_XBLIMPERSONATION, []);
	}

	public static function watermossmc_level_ambiguousFormat(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_level_backgroundGeneration(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_level_badDefaultFormat(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_level_conversion_finish(Translatable|string $worldName, Translatable|string $backupPath) : Translatable
	{
	...
	public static function watermossmc_level_conversion_start(Translatable|string $worldName) : Translatable
	{
	...
	public static function watermossmc_level_corrupted(Translatable|string $details) : Translatable
	{
	...
	public static function watermossmc_level_defaultError() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_LEVEL_DEFAULTERROR, []);
	}

	public static function watermossmc_level_generationError(Translatable|string $param0, Translatable|string $param1) : Translatable
	{
	...
	public static function watermossmc_level_invalidGeneratorOptions(Translatable|string $preset, Translatable|string $generatorName, Translatable|string $details) : Translatable
	{
	...
	public static function watermossmc_level_loadError(Translatable|string $param0, Translatable|string $param1) : Translatable
	{
	...
	public static function watermossmc_level_notFound(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_level_preparing(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_level_spawnTerrainGenerationProgress(Translatable|string $done, Translatable|string $total, Translatable|string $percentageDone) : Translatable
	{
	...
	public static function watermossmc_level_unknownFormat() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_LEVEL_UNKNOWNFORMAT, []);
	}

	public static function watermossmc_level_unknownGenerator(Translatable|string $generatorName) : Translatable
	{
	...
	public static function watermossmc_level_unloading(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_level_unsupportedFormat(Translatable|string $details) : Translatable
	{
	...
	public static function watermossmc_network_session_close(Translatable|string $reason) : Translatable
	{
	...
	public static function watermossmc_network_session_open() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_NETWORK_SESSION_OPEN, []);
	}

	public static function watermossmc_network_session_playerName(Translatable|string $playerName) : Translatable
	{
	...
	public static function watermossmc_player_invalidMove(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_player_logIn(Translatable|string $param0, Translatable|string $param1, Translatable|string $param2, Translatable|string $param3, Translatable|string $param4, Translatable|string $param5, Translatable|string $param6, Translatable|string $param7) : Translatable
	{
	...
	public static function watermossmc_player_logOut(Translatable|string $param0, Translatable|string $param1, Translatable|string $param2, Translatable|string $param3) : Translatable
	{
	...
	public static function watermossmc_plugin_aliasError(Translatable|string $param0, Translatable|string $param1, Translatable|string $param2) : Translatable
	{
	...
	public static function watermossmc_plugin_ambiguousMinAPI(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_plugin_badDataFolder(Translatable|string $dataFolder) : Translatable
	{
	...
	public static function watermossmc_plugin_circularDependency() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_PLUGIN_CIRCULARDEPENDENCY, []);
	}

	public static function watermossmc_plugin_commandError(Translatable|string $param0, Translatable|string $param1, Translatable|string $param2) : Translatable
	{
	...
	public static function watermossmc_plugin_deprecatedEvent(Translatable|string $param0, Translatable|string $param1, Translatable|string $param2) : Translatable
	{
	...
	public static function watermossmc_plugin_disable(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_plugin_disallowedByBlacklist() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_PLUGIN_DISALLOWEDBYBLACKLIST, []);
	}

	public static function watermossmc_plugin_disallowedByWhitelist() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_PLUGIN_DISALLOWEDBYWHITELIST, []);
	}

	public static function watermossmc_plugin_duplicateError(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_plugin_duplicatePermissionError(Translatable|string $permissionName) : Translatable
	{
	...
	public static function watermossmc_plugin_emptyExtensionVersionConstraint(Translatable|string $constraintIndex, Translatable|string $extensionName) : Translatable
	{
	...
	public static function watermossmc_plugin_enable(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_plugin_enableError(Translatable|string $param0, Translatable|string $param1) : Translatable
	{
	...
	public static function watermossmc_plugin_extensionNotLoaded(Translatable|string $extensionName) : Translatable
	{
	...
	public static function watermossmc_plugin_genericLoadError(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_plugin_incompatibleAPI(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_plugin_incompatibleExtensionVersion(Translatable|string $extensionVersion, Translatable|string $extensionName, Translatable|string $pluginRequirement) : Translatable
	{
	...
	public static function watermossmc_plugin_incompatibleOS(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_plugin_incompatiblePhpVersion(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_plugin_incompatibleProtocol(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_plugin_invalidAPI(Translatable|string $apiVersion) : Translatable
	{
	...
	public static function watermossmc_plugin_invalidExtensionVersionConstraint(Translatable|string $versionConstraint, Translatable|string $extensionName) : Translatable
	{
	...
	public static function watermossmc_plugin_invalidManifest(Translatable|string $details) : Translatable
	{
	...
	public static function watermossmc_plugin_load(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_plugin_loadError(Translatable|string $param0, Translatable|string $param1) : Translatable
	{
	...
	public static function watermossmc_plugin_mainClassAbstract() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_PLUGIN_MAINCLASSABSTRACT, []);
	}

	public static function watermossmc_plugin_mainClassNotFound() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_PLUGIN_MAINCLASSNOTFOUND, []);
	}

	public static function watermossmc_plugin_mainClassWrongType(Translatable|string $pluginInterface) : Translatable
	{
	...
	public static function watermossmc_plugin_restrictedName() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_PLUGIN_RESTRICTEDNAME, []);
	}

	public static function watermossmc_plugin_someEnableErrors() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_PLUGIN_SOMEENABLEERRORS, []);
	}

	public static function watermossmc_plugin_someLoadErrors() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_PLUGIN_SOMELOADERRORS, []);
	}

	public static function watermossmc_plugin_spacesDiscouraged(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_plugin_suicide() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_PLUGIN_SUICIDE, []);
	}

	public static function watermossmc_plugin_unknownDependency(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_save_start() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_SAVE_START, []);
	}

	public static function watermossmc_save_success(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_server_auth_disabled() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_SERVER_AUTH_DISABLED, []);
	}

	public static function watermossmc_server_auth_enabled() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_SERVER_AUTH_ENABLED, []);
	}

	public static function watermossmc_server_authProperty_disabled() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_SERVER_AUTHPROPERTY_DISABLED, []);
	}

	public static function watermossmc_server_authProperty_enabled() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_SERVER_AUTHPROPERTY_ENABLED, []);
	}

	public static function watermossmc_server_authWarning() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_SERVER_AUTHWARNING, []);
	}

	public static function watermossmc_server_defaultGameMode(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_server_devBuild_error1(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_server_devBuild_error2() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_SERVER_DEVBUILD_ERROR2, []);
	}

	public static function watermossmc_server_devBuild_error3() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_SERVER_DEVBUILD_ERROR3, []);
	}

	public static function watermossmc_server_devBuild_error4(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_server_devBuild_error5(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_server_devBuild_warning1(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_server_devBuild_warning2() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_SERVER_DEVBUILD_WARNING2, []);
	}

	public static function watermossmc_server_devBuild_warning3() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_SERVER_DEVBUILD_WARNING3, []);
	}

	public static function watermossmc_server_donate(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_server_forcingShutdown() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_SERVER_FORCINGSHUTDOWN, []);
	}

	public static function watermossmc_server_info(Translatable|string $param0, Translatable|string $param1) : Translatable
	{
	...
	public static function watermossmc_server_info_extended(Translatable|string $param0, Translatable|string $param1, Translatable|string $param2, Translatable|string $param3) : Translatable
	{
	...
	public static function watermossmc_server_license(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_server_networkStart(Translatable|string $param0, Translatable|string $param1) : Translatable
	{
	...
	public static function watermossmc_server_networkStartFailed(Translatable|string $ipAddress, Translatable|string $port, Translatable|string $errorMessage) : Translatable
	{
	...
	public static function watermossmc_server_obsolete_warning1(Translatable|string $param0, Translatable|string $param1) : Translatable
	{
	...
	public static function watermossmc_server_obsolete_warning2(Translatable|string $param0, Translatable|string $param1) : Translatable
	{
	...
	public static function watermossmc_server_obsolete_warning3(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_server_query_running(Translatable|string $param0, Translatable|string $param1) : Translatable
	{
	...
	public static function watermossmc_server_start(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_server_startFinished(Translatable|string $param0) : Translatable
	{
	...
	public static function watermossmc_server_tickOverload() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_SERVER_TICKOVERLOAD, []);
	}

	public static function watermossmc_plugins() : Translatable
	{
		return new Translatable(KnownTranslationKeys::POCKETMINE_PLUGINS, []);
	}

	public static function watermossmc_will_start(Translatable|string $param0) : Translatable
	{
	...
	public static function welcome_to_watermossmc(Translatable|string $param0) : Translatable
	{
