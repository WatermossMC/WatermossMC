...
class SetupWizard
{
	...
	{
		$this->message($this->lang->translate(KnownTranslationFactory::welcome_to_watermossmc(VersionInfo::NAME)));
		echo <<<LICENSE
...
LICENSE;
	...
	private function endWizard() : void
	{
		...
		$this->message($this->lang->translate(KnownTranslationFactory::watermossmc_plugins()));
		$this->message($this->lang->translate(KnownTranslationFactory::watermossmc_will_start(VersionInfo::NAME)));
